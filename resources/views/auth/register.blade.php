                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="exampleInputtext" name="name" :value="old('name')" required autofocus autocomplete="name" aria-describedby="textHelp">
                      @error('name')
                    ...
                    <div class="mb-3">
                      ...
                      <input type="email" class="form-control" id="exampleInputEmail1" name="email" aria-describedby="emailHelp" :value="old('email')" required autocomplete="username">
                      @error('email')
                      <span class="red-alert">
                        <strong>{{ $message }}</strong>
                      </span>
