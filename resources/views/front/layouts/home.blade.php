        ...
        <div class="cartmini__wrapper d-flex justify-content-between flex-column">
            ...
            <div class="cartmini__checkout">
                ...
                <div class="cartmini__checkout-btn">
                    <a href="{{ route('front.addtocart') }}" class="tp-btn mb-10 w-100"> view cart</a>
                    <a href="{{ route('front.checkout') }}" class="tp-btn tp-btn-border w-100"> checkout</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-xl-4 col-lg-3 col-md-8 col-6">
                            <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                                <div class="tp-header-login d-none d-lg-block">
                                    @if (Auth::user())
                                        <a href="{{ route('front.single-profile') }} "
                                    ...
                                    <div class="tp-header-action-item">
                                        <a href="{{ route('front.addtocart') }}">
                                         <button type="button" class="tp-header-action-btn ">
                                            ...
                                            <span class="tp-header-action-badge">5</span>
                                        </button>
                                        </a>
                                    </div>
                                    ...
                                    <nav class="tp-category-menu-content">
                                        <ul>
                                            @foreach ($categories as $category)
                                                <li>
                                                    <a href="{{ route('front.category', [$category->id, $category->slug]) }}">
                                                        <span>
                                ...
                                <div class="main-menu menu-style-1">
                                    <nav class="tp-main-menu-content">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="{{ route('front.new-release') }}">New Releases</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('front.todays-deal') }}">Deals Of The Day</a>
                                            </li>
                                            <li><a href="{{ route('front.blog') }}">Blog</a></li>
                                            {{-- <li>
                                       <a href="">Blog</a>
                                    </li> --}}
                                            <li><a href="{{ route('front.customer-service') }}">Contact</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 d-none d-md-block">
                        <div class="tp-header-sticky-menu main-menu menu-style-1">
                            <nav class="tp-main-menu-content" id="mobile-menu">
                                <ul>
                                    <li>
                                        <a href="{{ route('front') }}">Home</a>
                                    </li>
                            ...
                            <div class="tp-footer-widget footer-col-2 mb-50">
                                ...
                                <div class="tp-footer-widget-content">
                                    <ul>
                                        ...
                                        <li><a href="{{ route('front.single-profile') }}">My Account</a></li>
                                    ...
                                    <div class="tp-footer-contact">
                                        <div class="tp-footer-contact-item d-flex align-items-start">
                                            ...
                                            <div class="tp-footer-contact-content">
                                                <p><a
                                                        href="https://html.weblearnbd.net/cdn-cgi/l/email-protection#15667d7a736c55666065657a67613b767a78"><span
                                                            class="__cf_email__"
                                                            data-cfemail="33405b5c554a73404643435c41471d505c5e">[email&#160;protected]</span></a>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="tp-footer-contact-item d-flex align-items-start">
