                ...
                <div class="breadcrumb__content p-relative z-index-1">
                   <div class="breadcrumb__list has-icon">
                      ...
                      @foreach ($category->products as $cat)
                        ...
                        <span><a href="{{ route('front.category', [$cat->id, $cat->slug]) }}">{{ $cat->product_category_name }}</a></span>
                      
                        <span><a href="{{ route('front.product-page', [$cat->id, $cat->slug]) }}">{{ $cat->product_subcategory_name }}</a></span>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="tp-product-details-wrapper">
                        ...
                        <p>{{ $product->product_short_desc }} ... <span>See more</span></p>
                           ...
                           <div class="tp-product-details-action-wrapper">
                              ...
                              <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                                 ...
                                 <div class="tp-product-quantity mb-15 mr-15">
                                       ...
                                       <input class="tp-cart-input" type="text" min="1" name="product_quantity">
       ...
       <div class="container">
          <div class="row">
             <div class="tp-section-title-wrapper-6 text-center mb-40">
                <span class="tp-section-title-pre-6"></span>
                           ...
                           <div class="tp-product-item-3 tp-product-style-primary mb-50">
                              ...
                              <div class="tp-product-content-3">
                                 ...
                                 <div class="tp-product-price-wrapper-3">
                                    <span class="tp-product-price-3 new-price">₦ {{ $product->price }}</span>
                                 </div>
                              </div>
                           </div>
                        </div>
          ...
          <div class="modal-content">
             <div class="tp-product-modal-content d-lg-flex align-items-start">
                ...
                <div class="tp-product-details-wrapper">
                   ...
                   <h3 class="tp-product-details-title">{{ $product->product_subcategory_name }}</h3>
