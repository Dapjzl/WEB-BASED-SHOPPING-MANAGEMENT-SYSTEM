       ...
       <div class="row">
          <div class="col-xxl-12">
             <div class="breadcrumb__content p-relative z-index-1">
                <h3 class="breadcrumb__title">{{ $category->subcategory_name }}</h3>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="tp-shop-top-left d-flex align-items-center ">
                                ...
                                {{-- <p>Showing 1–14 of {{ $subcategory->product_count }} results</p> --}}
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6">
                        ...
                        @foreach ($products as $product)
                                ...
                                <div class="tp-product-item-2 mb-40">
                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                        <a href="{{ route('front.single-product', [$product->id,$product->slug]) }}">
                                    ...
                                    <div class="tp-product-content-2 pt-15">
                                        ...
                                        <h3 class="tp-product-title-2">
                                            <a href="{{ route('front.single-product',[$product->id,$product->slug]) }}">{{ $product->product_name }}</>
                                        </h3>
                                ...
                                <div class="col-xl-8">
                                    <div class="tp-product-list-item d-md-flex">
                                        <div class="tp-product-list-thumb p-relative fix">
                                            <a href="#">
                                            <img src="{{ asset('frontend/assets/img/product/list/product-list-2.jpg')}}" alt="">
                                            </a>
                                    ...
                                    <div class="tp-product-list-item d-md-flex">
                                        <div class="tp-product-list-thumb p-relative fix">
                                            <a href="#">
                                            <img src="{{ asset('frontend/assets/img/product/list/product-list-3.jpg')}}" alt="">
                                            </a>
                                    ...
                                    <div class="tp-product-list-item d-md-flex">
                                        <div class="tp-product-list-thumb p-relative fix">
                                            <a href="#">
                                            <img src="{{ asset('frontend/assets/img/product/list/product-list-4.jpg')}}" alt="">
                                            </a>
                                    ...
                                    <div class="tp-product-list-item d-md-flex">
                                        <div class="tp-product-list-thumb p-relative fix">
                                            <a href="#">
                                            <img src="{{ asset('frontend/assets/img/product/list/product-list-5.jpg')}}" alt="">
                                            </a>
                                    ...
                                    <div class="tp-product-list-item d-md-flex">
                                        <div class="tp-product-list-thumb p-relative fix">
                                            <a href="#">
                                            <img src="{{ asset('frontend/assets/img/product/list/product-list-6.jpg')}}" alt="">
                                            </a>
                                    ...
                                    <div class="tp-product-list-item d-md-flex">
                                        <div class="tp-product-list-thumb p-relative fix">
                                            <a href="#">
                                            <img src="{{ asset('frontend/assets/img/product/list/product-list-7.jpg')}}" alt="">
                                            </a>
                                    ...
                                    <div class="tp-product-list-item d-md-flex">
                                        <div class="tp-product-list-thumb p-relative fix">
                                            <a href="#">
                                            <img src="{{ asset('frontend/assets/img/product/list/product-list-1.jpg')}}" alt="">
                                            </a>
