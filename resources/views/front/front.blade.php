...
<main>
            ...
            @foreach ($subcategory as $subcategory)
               <div class="col">
                  <div class="tp-product-category-item text-center mb-40">
                     @foreach ($subcategory->subcategories as $subs)
                     <div class="tp-product-category-thumb fix">
                        <a href="{{route('front.product-page', [$subs->id,$subs->slug])}}">
                           <img src="{{ asset('frontend/assets/img/product/category/product-cat-1.png')}}" alt="product-category">
                        </a>
                     </div>
                     <div class="tp-product-category-content">
                           <h3 class="tp-product-category-title">
                              <a href="{{ route('front.product-page', [$subs->id, $subs->slug]) }}">
                                 {{ $subs->subcategory_name}}</a>
                           </h3>
                     </div>
                     @endforeach
                            ...
                            <div class="col-xl-3 col-lg-3 col-sm-6">
                               <div class="tp-product-item p-relative transition-3 mb-25">
                                  <div class="tp-product-thumb p-relative fix m-img">
                                     <a href="{{ route('front.single-product', [$allproduct->id, $allproduct->slug]) }}">
                                        <img src="{{ asset($allproduct->product_img)}}" alt="image">
                                     </a>

                                     <!-- product badge -->
                                     <div class="tp-product-badge">
                                       <span class="product-hot">
                                          {{ $allproduct->product_category_name }}</span>
                                    </div> 
                                  ...
                                  <div class="tp-product-content">
                                     <div class="tp-product-category">
                                        <a href="shop.html">{{ $allproduct->product_subcategory_name }}</a>
                                     </div>
                                     ...
                                     <div class="tp-product-price-wrapper">
                                        <span class="tp-product-price new-price"> ₦ {{ $allproduct->price }}</span>
                                     </div>
                                  </div>
                               </div>
                            </div>
          ...
          <div class="row">
             <div class="col-xl-8 col-lg-7">
                <div class="tp-banner-item tp-banner-height p-relative mb-30 z-index-1 fix">
                   <div class="tp-banner-thumb include-bg transition-3" data-background="{{ asset('frontend/assets/img/product/banner/product-banner-1.jpg')}}"></div>
             ...
             <div class="col-xl-4 col-lg-5">
                <div class="tp-banner-item tp-banner-item-sm tp-banner-height p-relative mb-30 z-index-1 fix">
                   <div class="tp-banner-thumb include-bg transition-3" data-background="{{ asset('frontend/assets/img/product/banner/product-banner-2.jpg')}}"></div>
                   <div class="tp-banner-content">
                      <h3 class="tp-banner-title">
                   ...
                   <div class="tp-product-offer-slider-active swiper-container">
                      <div class="swiper-wrapper">
                         <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/offer/product-offer-1.jpg')}}" alt="product-electronic">
                               </a>
                         ...
                         <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/offer/product-offer-2.jpg')}}" alt="product-electronic">
                               </a>
                         ...
                         <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/offer/product-offer-3.jpg')}}" alt="product-electronic">
                               </a>
                ...
                <div class="tp-product-gadget-sidebar mb-40">
                   <div class="tp-product-gadget-categories p-relative fix mb-10">
                      <div class="tp-product-gadget-thumb">
                         <img src="{{ asset('frontend/assets/img/product/gadget/gadget-girl.png')}}" alt="">
                      </div>
                   ...
                   <div class="tp-product-gadget-banner">
                      <div class="tp-product-gadget-banner-slider-active swiper-container">
                         <div class="swiper-wrapper">
                            <div class="tp-product-gadget-banner-item swiper-slide include-bg" data-background="{{ asset('frontend/assets/img/product/gadget/gadget-banner-1.jpg')}}">
                            ...
                            <div class="tp-product-gadget-banner-item swiper-slide include-bg" data-background="{{ asset('frontend/assets/img/product/gadget/gadget-banner-2.jpg')}}">
                               <div class="tp-product-gadget-banner-content">
                   ...
                   <div class="row">
                      <div class="col-xl-4 col-sm-6">
                         <div class="tp-product-item p-relative transition-3 mb-25">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/product-12.jpg')}}" alt="product-electronic">
                               </a>
                      ...
                      <div class="col-xl-4 col-sm-6">
                         <div class="tp-product-item p-relative transition-3 mb-25">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/product-13.jpg')}}" alt="product-electronic">
                               </a>
                      ...
                      <div class="col-xl-4 col-sm-6">
                         <div class="tp-product-item p-relative transition-3 mb-25">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/product-14.jpg')}}" alt="product-electronic">
                               </a>
                      ...
                      <div class="col-xl-4 col-sm-6">
                         <div class="tp-product-item p-relative transition-3 mb-25">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/product-15.jpg')}}" alt="product-electronic">
                               </a>
                      ...
                      <div class="col-xl-4 col-sm-6">
                         <div class="tp-product-item p-relative transition-3 mb-25">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/product-16.jpg')}}" alt="product-electronic">
                               </a>
                      ...
                      <div class="col-xl-4 col-sm-6">
                         <div class="tp-product-item p-relative transition-3 mb-25">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/product-17.jpg')}}" alt="product-electronic">
                               </a>
                         ...
                         <div class="col-xl-6 col-lg-6">
                            <div class="tp-product-banner-thumb-wrapper p-relative">
                               ...
                               <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                                  <img src="{{ asset('frontend/assets/img/banner/banner-slider-1.png')}}" alt="">
                               </div>
                            </div>
                         </div>
                      </div>
                      ...
                      <div class="row align-items-center">
                         ...
                         <div class="col-xl-6 col-lg-6">
                            <div class="tp-product-banner-thumb-wrapper p-relative">
                               ...
                               <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                                  <img src="{{ asset('frontend/assets/img/banner/banner-slider-2.png')}}" alt="">
                               </div>
                            </div>
                         </div>
                      </div>
                      ...
                      <div class="row align-items-center">
                         ...
                         <div class="col-xl-6 col-lg-6">
                            <div class="tp-product-banner-thumb-wrapper p-relative">
                               ...
                               <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                                  <img src="{{ asset('frontend/assets/img/banner/banner-slider-3.png')}}" alt="">
                               </div>
                            </div>
                         </div>
                      </div>
                   ...
                   <div class="tp-product-arrival-active swiper-container">
                      <div class="swiper-wrapper">
                         <div class="tp-product-item transition-3 mb-25 swiper-slide">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/product-6.jpg')}}" alt="product-electronic">
                               </a>
                         ...
                         <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/product-7.jpg')}}" alt="product-electronic">
                               </a>
                         ...
                         <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/product-8.jpg')}}" alt="product-electronic">
                               </a>
                         ...
                         <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/product-9.jpg')}}" alt="product-electronic">
                               </a>
                         ...
                         <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                            <div class="tp-product-thumb p-relative fix m-img">
                               <a href="product-details.html">
                                  <img src="{{ asset('frontend/assets/img/product/product-10.jpg')}}" alt="product-electronic">
                               </a>
                   ...
                   <div class="tp-product-sm-wrapper mr-20">
                      <div class="tp-product-sm-item d-flex align-items-center">
                         <div class="tp-product-thumb mr-25 fix">
                            <a href="product-details.html">
                               <img src="{{ asset('frontend/assets/img/product/sm/product-sm-1.jpg')}}" alt="">
                            </a>
                         </div>
                      ...
                      <div class="tp-product-sm-item d-flex align-items-center">
                         <div class="tp-product-thumb mr-25 fix">
                            <a href="product-details.html">
                               <img src="{{ asset('frontend/assets/img/product/sm/product-sm-2.jpg')}}" alt="">
                            </a>
                         </div>
                         <div class="tp-product-sm-content">
                            <div class="tp-product-category">
                      ...
                      <div class="tp-product-sm-item d-flex align-items-center">
                         <div class="tp-product-thumb mr-25 fix">
                            <a href="product-details.html">
                               <img src="{{ asset('frontend/assets/img/product/sm/product-sm-3.jpg')}}" alt="">
                            </a>
                         </div>
                         <div class="tp-product-sm-content">
                            <div class="tp-product-category">
                ...
                <div class="tp-product-sm-list mb-50">
                   ...
                   <div class="tp-product-sm-wrapper mr-20">
                      <div class="tp-product-sm-item d-flex align-items-center">
                         <div class="tp-product-thumb mr-25 fix">
                            <a href="product-details.html">
                               <img src="{{ asset('frontend/assets/img/product/sm/product-sm-4.jpg')}}" alt="">
                            </a>
                         </div>
                         <div class="tp-product-sm-content">
                            <div class="tp-product-category">
                      ...
                      <div class="tp-product-sm-item d-flex align-items-center">
                         <div class="tp-product-thumb mr-25 fix">
                            <a href="product-details.html">
                               <img src="{{ asset('frontend/assets/img/product/sm/product-sm-5.jpg')}}" alt="">
                            </a>
                         </div>
                         <div class="tp-product-sm-content">
                            <div class="tp-product-category">
                      ...
                      <div class="tp-product-sm-item d-flex align-items-center">
                         <div class="tp-product-thumb mr-25 fix">
                            <a href="product-details.html">
                               <img src="{{ asset('frontend/assets/img/product/sm/product-sm-6.jpg')}}" alt="">
                            </a>
                         </div>
                         <div class="tp-product-sm-content">
                            <div class="tp-product-category">
                ...
                <div class="tp-product-sm-list mb-50">
                   ...
                   <div class="tp-product-sm-wrapper mr-20">
                      <div class="tp-product-sm-item d-flex align-items-center">
                         <div class="tp-product-thumb mr-25 fix">
                            <a href="product-details.html">
                               <img src="{{ asset('frontend/assets/img/product/sm/product-sm-7.jpg')}}" alt="">
                            </a>
                         </div>
                         <div class="tp-product-sm-content">
                            <div class="tp-product-category">
                      ...
                      <div class="tp-product-sm-item d-flex align-items-center">
                         <div class="tp-product-thumb mr-25 fix">
                            <a href="product-details.html">
                               <img src="{{ asset('frontend/assets/img/product/sm/product-sm-8.jpg')}}" alt="">
                            </a>
                         </div>
                         <div class="tp-product-sm-content">
                            <div class="tp-product-category">
                      ...
                      <div class="tp-product-sm-item d-flex align-items-center">
                         <div class="tp-product-thumb mr-25 fix">
                            <a href="product-details.html">
                               <img src="{{ asset('frontend/assets/img/product/sm/product-sm-9.jpg')}}" alt="">
                            </a>
                         </div>
                         <div class="tp-product-sm-content">
                            <div class="tp-product-category">
    ...
    <section class="tp-subscribe-area pt-70 pb-65 theme-bg p-relative z-index-1">
       <div class="tp-subscribe-shape">
          ...
          <img class="tp-subscribe-shape-4" src="{{ asset('frontend/assets/img/subscribe/subscribe-shape-4.png')}}" alt="">
          <!-- plane shape -->
            ...
            <div class="tp-product-modal-content d-lg-flex align-items-start">
               ...
               <div class="tp-product-details-wrapper">
                  <div class="tp-product-details-category">
                     <span>{{ $product->product_category_name }}</span> <br>
                  ...
                  <p>{{ $product->product_long_desc }} <span>See more</span></p>
