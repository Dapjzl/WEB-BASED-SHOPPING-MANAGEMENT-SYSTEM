...
<main>
    ...
    <section class="breadcrumb__area include-bg pt-150 pb-150 breadcrumb__overlay breadcrumb__style-3" data-background="{{ asset('frontend/assets/img/breadcrumb/breadcrumb-bg-1.jpg')}}">
       <div class="container">
          <div class="row">
                ...
                <div class="tp-postbox-wrapper pr-50">
                   <article class="tp-postbox-item format-image mb-50 transition-3">
                      <div class="tp-postbox-thumb w-img">
                         <a href="blog-details.html">
                            <img src="{{ asset('frontend/assets/img/blog/blog-big-3.jpg')}}" alt="">
                         </a>
                      </div>
                   ...
                   <article class="tp-postbox-item format-video mb-50 transition-3">
                      <div class="tp-postbox-thumb tp-postbox-video w-img p-relative">
                         <a href="blog-details.html">
                            <img src="{{ asset('frontend/assets/img/blog/blog-big-2.jpg')}}" alt="">
                         </a>
                      ...
                      <div class="tp-postbox-thumb tp-postbox-slider swiper-container w-img p-relative">
                         <div class="swiper-wrapper">
                            <div class="tp-postbox-slider-item swiper-slide">
                               <img src="{{ asset('frontend/assets/img/blog/blog-big-4.jpg')}}" alt="">
                            </div>
                            <div class="tp-postbox-slider-item swiper-slide">
                               <img src="{{ asset('frontend/assets/img/blog/blog-big-5.jpg')}}" alt="">
                            </div>
                            <div class="tp-postbox-slider-item swiper-slide">
                               <img src="{{ asset('frontend/assets/img/blog/blog-big-6.jpg')}}" alt="">
                            </div>
                         </div>
                      ...
                      <div class="tp-sidebar-widget-content">
                         <div class="tp-sidebar-about">
                            <div class="tp-sidebar-about-thumb mb-25">
                               <a href="#">
                                  <img src="{{ asset('frontend/assets/img/users/user-11.jpg')}}" alt="">
                               </a>
                            </div>
                            <div class="tp-sidebar-about-content">
                               ...
                               <div class="tp-sidebar-about-signature">
                                  <img src="{{ asset('frontend/assets/img/blog/signature/signature.png')}}" alt="">
                               </div>
                            </div>
                         </div>
                      </div>
                         ...
                         <div class="tp-sidebar-blog-item-wrapper">
                            <div class="tp-sidebar-blog-item d-flex align-items-center">
                               <div class="tp-sidebar-blog-thumb">
                                  <a href="blog-details.html">
                                     <img src="{{ asset('frontend/assets/img/blog/sidebar/blog-sidebar-1.jpg')}}" alt="">
                                  </a>
                               </div>
                            ...
                            <div class="tp-sidebar-blog-item d-flex align-items-center">
                               <div class="tp-sidebar-blog-thumb">
                                  <a href="blog-details.html">
                                     <img src="{{ asset('frontend/assets/img/blog/sidebar/blog-sidebar-2.jpg')}}" alt="">
                                  </a>
                               </div>
                               <div class="tp-sidebar-blog-content">
                                  <div class="tp-sidebar-blog-meta">
                            ...
                            <div class="tp-sidebar-blog-item d-flex align-items-center">
                               <div class="tp-sidebar-blog-thumb">
                                  <a href="blog-details.html">
                                     <img src="{{ asset('frontend/assets/img/blog/sidebar/blog-sidebar-3.jpg')}}" alt="">
                                  </a>
                               </div>
                               <div class="tp-sidebar-blog-content">
                                  <div class="tp-sidebar-blog-meta">
