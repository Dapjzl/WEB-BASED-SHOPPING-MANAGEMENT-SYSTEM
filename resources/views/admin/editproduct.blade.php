        ...
        <div class="card-body p-4">
          <div class="mb-4 row align-items-center">
            ...
            <div class="col-sm-9">
              <div class="input-group border rounded-1">
                ...
                <input type="text" class="form-control border-0 ps-2" name="product_name" value="{{ $product_info->product_name }}">
              </div>
          ...
          <div class="mb-4 row align-items-center">
            ...
            <div class="col-sm-9">
              <div class="input-group border rounded-1">
                ...
                <input type="number" class="form-control border-0 ps-2" name="price" value="{{ $product_info->price  }}">
              </div>
          ...
          <div class="mb-4 row align-items-center">
            ...
            <div class="col-sm-9">
              <div class="input-group border rounded-1">
                ...
                <input type="number" class="form-control border-0 ps-2" name="quantity" value="{{ $product_info->quantity }}">
              </div>
          ...
          <div class="mb-4 row align-items-center">
            ...
            <div class="col-sm-9">
              <div class="input-group border rounded-1">
                ...
                <input type="text" class="form-control border-0 ps-2" name="product_short_desc" value="{{ $product_info->product_short_desc}}">
              </div>
          ...
          <div class="mb-4 row align-items-center">
            ...
            <div class="col-sm-9">
              <div class="input-group border rounded-1">
                ...
                <textarea class="form-control p-7 border-0 ps-2" name="product_long_desc" id="" cols="20" rows="1"></textarea>
              </div>
          ...
          <div class="mb-4 row align-items-center">
            ...
            <div class="col-sm-9">
              ...
              <img src="{{ asset($product_info->product_img) }}" alt="" class="imgsetup">
            </div>
          </div>
          <div class="row">
