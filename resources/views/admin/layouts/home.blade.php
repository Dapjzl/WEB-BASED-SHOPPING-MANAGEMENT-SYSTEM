...
<head>
      ...
      <aside class="left-sidebar">
        ...
        <div>
          <div class="brand-logo d-flex align-items-center justify-content-between">
            <a href="{{\URL::to('index')}}" class="text-nowrap logo-img">
            ...
            <ul id="sidebarnav">
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="{{ route('admin.addcategory') }}" class="sidebar-link">
                  ...
                  <li class="sidebar-item">
                    <a href="{{ route('admin.allcategory') }}" class="sidebar-link">
                      <div class="round-16 d-flex align-items-center justify-content-center">
                        <i class="ti ti-circle"></i>
                      </div>
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="{{ route('admin.addsubcategory') }}" class="sidebar-link">
                      <div class="round-16 d-flex align-items-center justify-content-center">
                        <i class="ti ti-circle"></i>
                      </div>
                  ...
                  <li class="sidebar-item">
                    <a href="{{ route('admin.allsubcategory') }}" class="sidebar-link">
                      <div class="round-16 d-flex align-items-center justify-content-center">
                        <i class="ti ti-circle"></i>
                      </div>
                      <span class="hide-menu">View Sub-Category</span>
                    </a>
                  </li>
                  {{-- 
                    <li class="sidebar-item">
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="{{ route('admin.pendingorder') }}" class="sidebar-link">
                      <div class="round-16 d-flex align-items-center justify-content-center">
                        <i class="ti ti-circle"></i>
                      </div>
                      <span class="hide-menu">Pending Order</span>
                    </a>
                  </li>
                  {{-- <li class="sidebar-item">
            ...
            {{-- <div class="unlimited-access hide-menu bg-light-primary position-relative my-7 rounded">
              <div class="d-flex">
                ...
                <div class="unlimited-access-img">
                  <img src="{{ asset('backend/dist/images/backgrounds/rocket.png" alt="" class="img-fluid">
                </div>
              </div>
            </div> --}}
          </nav>
    ...
    <div class="offcanvas offcanvas-end shopping-cart" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
      ...
      <div class="offcanvas-body h-100 px-4 pt-0" data-simplebar>
        <ul class="mb-0">
          <li class="pb-7">
            <div class="d-flex align-items-center">
              <img src="{{ asset('backend/dist/images/products/product-1.jpg')}}" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
              <div>
          ...
          <li class="pb-7">
            <div class="d-flex align-items-center">
              <img src="{{ asset('backend/dist/images/products/product-2.jpg')}}" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
              <div>
                <h6 class="mb-1">Supreme toys cooker</h6>
                <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                <div class="d-flex align-items-center justify-content-between mt-2">
          ...
          <li class="pb-7">
            <div class="d-flex align-items-center">
              <img src="{{ asset('backend/dist/images/products/product-3.jpg')}}" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
              <div>
                <h6 class="mb-1">Supreme toys cooker</h6>
                <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                <div class="d-flex align-items-center justify-content-between mt-2">
        ...
        <ul>
          <li class="pb-4 border-bottom">
            <div class="d-flex align-items-center py-2">
              <img src="{{ asset('backend/dist/images/products/product-1.jpg')}}" width="98" class="rounded-2 me-3" alt="" />
              <div>
          ...
          <li class="py-4 border-bottom">
            <div class="d-flex align-items-center py-2">
              <img src="{{ asset('backend/dist/images/products/product-2.jpg')}}" width="98" class="rounded-2 me-3" alt="" />
              <div>
                <h6 class="fs-4 fw-normal mb-0">Supreme toys cooker</h6>
                <p class="mb-0 text-muted fs-3">Kitchenware Item</p>
                <div class="d-flex align-items-center mt-1">
          ...
          <li class="py-4 border-bottom">
            <div class="d-flex align-items-center py-2">
              <img src="{{ asset('backend/dist/images/products/product-3.jpg')}}" width="98" class="rounded-2 me-3" alt="" />
              <div>
                <h6 class="fs-4 fw-normal mb-0">Supreme toys cooker</h6>
                <p class="mb-0 text-muted fs-3">Kitchenware Item</p>
                <div class="d-flex align-items-center mt-1">
  ...
  <div class="offcanvas offcanvas-end customizer" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" data-simplebar="">
    ...
    <script src="{{ asset('backend/dist/js/dashboard2.js')}}"></script>
